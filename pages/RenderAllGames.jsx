              ...
              <GameListItem key={uuid()}>
                ...
                <SepDivRight>
                  <RightWrap>
                    ...
                    <SettingArea>
                      <Link href={{
                        pathname: `/editgame/[name]`,
                        query: {
                          name: _id,
                          props: JSON.stringify(game)
                        }
                      }} as={`/editgame/${[_id]}`} style='display: none'><SettingBtn key={uuid()} id="setting" ></SettingBtn></Link>
